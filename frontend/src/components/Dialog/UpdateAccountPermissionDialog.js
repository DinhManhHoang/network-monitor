...
function UpdateAccountPermissionDialog({ isOpen, setIsOpen, current, setCurrent, updatePermissionState, updatePermissionAction, getAllAccountGroupsState }) {
...
export default withGetAllAccountGroups(withUpdatePermission(UpdateAccountPermissionDialog));